...
def fileinfo(files):
    ...
    if nfiles==1 and (type(files)==str or type(files)==str):
        files = [files]

    # Create structure 
    dt = [('file',(str,300)),('dir',(str,300)),('base',(str,100)),('ext',(str,10)),('exists',bool),
          ('size',int),('nx',int),('ny',int),('filter',(str,50)),('exptime',float),
          ('dateobs',(str,30)),('mjd',float),('pixscale',float),('cenra',float),('cendec',float),
...
def getgain(filename=None,head=None):
    ...
    if nfiles > 1:
        ...
        keyword = np.zeros(nfiles,(str,50))
        for i in range(nfiles): 
...
def getfilter(filename=None,setup=None,head=None,numeric=False,noupdate=False,
    ...
    if (nfiles > 1): 
        filters = np.zeros(nfiles,(str,50))
    ...
    if (nfiles == 0 and nfiltname > 1): 
        filters = np.zeros(nfiltname,(str,50))
...
def readtrans(transfile,silent=False,logfile=None):
    ...
    dt = [('night',int),('chip',int),('file',str,300),('band',str,10),('color',str,10),('colband',str,10),
